...
Mock.mock("manager_api/manager/dictionary/driver", "get", {
  ...
  ok: true, 
  data: [
    { label: "ADriver", value: "ADriver" },
    { label: "BDriver", value: "BDriver" },
    { label: "CDriver", value: "CDriver" },
    { label: "DDriver", value: "DDriver" },
    { label: "EDriver", value: "EDriver" },
    { label: "FDriver", value: "FDriver" }
  ]
});
